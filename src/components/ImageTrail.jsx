...
// ... variants 2..8 omitted for brevity in file, but variantMap will reference only variant 1 by default
// For this initial integration we include the first 4 variants which are sufficient
...
export default function ImageTrail({ items = [], variant = 1 }) {
  ...
  useEffect(() => {
    ...
    return () => {
      // no explicit destroy on the original implementation; basic cleanup: remove listeners and let GC collect
      try {
